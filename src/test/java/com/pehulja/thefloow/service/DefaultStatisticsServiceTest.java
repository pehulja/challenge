...
public class DefaultStatisticsServiceTest implements Supplier<Statistics> {
    ...
    public void optimisticUpdate() throws Exception {
        ...
        Statistics updated = defaultStatisticsService.optimisticUpdate(statistics, new DefaultStatisticsService.MergePolicy());
        ...
        updated = defaultStatisticsService.optimisticUpdate(statistics, new DefaultStatisticsService.MergePolicy());
