...
/**
 * Service that charcter by character read text file and split it into chunks to avoid memory issues
 */
@Slf4j
@Service
    ...
    public Future<?> chunksProcessor(Path path, Consumer<FileChunk> fileChunkConsumer) throws IOException {
        ...
        return executorService.submit(() -> {
            try (FileReader reader = new FileReader(path.toFile())) {
                ...
                // Execute processor for last chunk
