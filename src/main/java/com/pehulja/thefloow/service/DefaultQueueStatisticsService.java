...
import static com.pehulja.thefloow.queue.QueueStatistics.FAILED;
import static com.pehulja.thefloow.queue.QueueStatistics.PUSHED;
import static com.pehulja.thefloow.queue.QueueStatistics.SUCCESS;
 ...
 */
@Service
public class DefaultQueueStatisticsService implements QueueStatisticsService, InitializingBean
{
    @Autowired
